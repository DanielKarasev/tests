...
def test_add_archive_adapted_file(page):
    with allure.step('Открытие страницы'):
        foop_list_page = FOOPListPage(page, link)
        foop_list_page.open()
    foop_list_page.add_full_adapted_file()
...
def test_add_archive_unadapted_file_without_base_name(page):
    with allure.step('Открытие страницы'):
        foop_list_page = FOOPListPage(page, link)
        foop_list_page.open()
...
def test_add_archive_unadapted_file_without_base_date(page):
    with allure.step('Открытие страницы'):
        foop_list_page = FOOPListPage(page, link)
        foop_list_page.open()
...
@allure.story("Создание архивной неадаптированной записи")
@allure.title("Создание записи со всеми заполнеными полями")
def test_add_archive_nonadapted_file(page):
    with allure.step('Открытие страницы'):
        foop_list_page = FOOPListPage(page, link)
        foop_list_page.open()
...
def test_add_adapted_file(page):
    with allure.step('Открытие страницы'):
        foop_list_page = FOOPListPage(page, link)
        foop_list_page.open()
...
def test_add_nonadapted_file(page):
    with allure.step('Открытие страницы'):
        foop_list_page = FOOPListPage(page, link)
        foop_list_page.open()
...
def test_edit_file_base_name(page):
    with allure.step('Открытие страницы'):
        foop_list_page = FOOPListPage(page, link)
        foop_list_page.open()
    foop_list_page.add_full_adapted_file()
...
def test_delete_file_base_name(page):
    with allure.step('Открытие страницы'):
        foop_list_page = FOOPListPage(page, link)
        foop_list_page.open()
    foop_list_page.add_full_adapted_file()
...
def test_add_file_base_name(page):
    with allure.step('Открытие страницы'):
        foop_list_page = FOOPListPage(page, link)
        foop_list_page.open()
    foop_list_page.add_file_unadapted_without_base_name()
...
def test_delete_file_base_date(page):
    with allure.step('Открытие страницы'):
        foop_list_page = FOOPListPage(page, link)
        foop_list_page.open()
    foop_list_page.add_full_adapted_file()
...
def test_add_file_base_date(page):
    with allure.step('Открытие страницы'):
        foop_list_page = FOOPListPage(page, link)
        foop_list_page.open()
    foop_list_page.add_file_unadapted_without_base_date()
